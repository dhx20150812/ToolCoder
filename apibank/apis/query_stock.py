...
class QueryStock(API):
    ...
    def check_api_call_correctness(self, response, groundtruth) -> bool:
        ...
        response_stock_code, response_date = self.format_check(
            response_stock_code, response_date
        )
        groundtruth_stock_code, groundtruth_date = self.format_check(
            groundtruth_stock_code, groundtruth_date
        )
